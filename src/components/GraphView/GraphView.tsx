    ...
    <div className="w-full h-full bg-background">
      <ReactFlowProvider>
        ...
        >
          ...
          <div style={{ position: 'absolute', top: 10, left: 10, zIndex: 4 }} className="space-y-2">
            <GraphControls />
          </div>

          {/* Performance Monitor */}
          <div style={{ position: 'absolute', bottom: 10, right: 10, zIndex: 4 }} className="glass-panel p-2">
